...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"熙选","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.skuFormat = exports.timeFormat = exports.telFormat = void 0;var telFormat = function telFormat(num) {//手机号脱敏
  if (!num) return '';
  if (typeof num === 'number') num = String(num);
  return num.replace(/(\d{3})\d*(\d{4})/, '$1****$2');
};exports.telFormat = telFormat;

var timeFormat = function timeFormat(value) {var start = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;var end = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 10; //时间格式化
  if (!value) return '';
  return value.substring(start, end);
};exports.timeFormat = timeFormat;

var skuFormat = function skuFormat(value) {//规格格式化
  if (!value) return '';
  if (Array.isArray(value)) {
    return value.join('-');
        ...
        if (res.statusCode === 200) {
          ...
          if (data.success) {
            ...
            if (data.code != "T031" && data.code != "B999") {
              ...
              (0, _utils.showToast)(data.message || '出错啦，请稍后再试');
  ...
  statusFail: function statusFail(err) {
    ...
    if (err && err.response) {
      ...
      if (err.errMsg.indexOf("timeout") > -1) {
        (0, _utils.showToast)("连接超时");
      } else if (err.errMsg.indexOf("request:fail") > -1) {
        (0, _utils.showToast)("连接断开");
      } else {
      ...
      if (_str.indexOf("statusCode") > -1) {
        (0, _utils.showToast)("【小二】开小差，服务器连接不上");
      } else {
